...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("exports = module.exports = __webpack_require__(10)();\nexports.push([module.id, \"html,body{margin:0;padding:0}@font-face{font-family:'karlaregular';src:url(\"+__webpack_require__(18)+\");src:url(\"+__webpack_require__(18)+\"?#iefix) format('embedded-opentype'),url(\"+__webpack_require__(21)+\") format('woff'),url(\"+__webpack_require__(19)+\") format('truetype'),url(\"+__webpack_require__(20)+\"#karlaregular) format('svg');font-weight:normal;font-style:normal;}body{background-color:#EBF0F7}body .d3-svg{width:100%;height:100%}\", \"\"]);\n\n/*****************\n ** WEBPACK FOOTER\n ** ./~/css-loader!./~/sass-loader!./sass/style.scss\n ** module id = 5\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./sass/style.scss?./~/css-loader!./~/sass-loader");
